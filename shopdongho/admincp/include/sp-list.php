...
<table width="735" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="10" class="tieude" align="center">DANH SÁCH SẢN PHẨM</td>
  </tr>
  <tr height="30" bgcolor="#ffcc99">
    ...
    <td align="center" width="80" style="border-right:1px solid #333"><strong>Ghi Chú</strong></td>
		<td align="center" width="50" style="border-right:1px solid #333"><strong>Tồn</strong></td>
    <td align="center" width="50" style="border-right:1px solid #333"><strong>Sửa</strong></td>
    <td align="center" width="50" style="border-right:1px solid #333"><strong>Xóa</strong></td>    
...
<?php
	...
	//******************************** Nội Dung *********************************//
		...
		{
			$tensp=$r3['tensp']; $mota=$r3['mota'] ; $ghichu=$r3["ghichu"];$soluongnhaphang=$r3["soluongnhaphang"];
			$mota=$r3["mota"];$soluongban=$r3["soluongban"];$ton=$soluongnhaphang-$soluongban;
  ...
  <input type="checkbox" name="chon[]" value="<?php echo $id; ?>"/></td>  
	...
	<td width="80" align="center" style="border-bottom:1px solid #333; border-right:1px solid #333"><?php  echo "$ton"; ?></td>   
