...
//	echo "$name - $new<hr>";
	...
	{	
		if($id2!=$id){
			$sql5="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota', gia='$gia',ghichu='$ghichu', soluongnhaphang='$soluongnhaphang',hinh='$new',id_menu='$menu' WHERE id='$id'";
			...
			$sql3="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota', gia='$gia',ghichu='$ghichu',soluongnhaphang='$soluongnhaphang',id_menu='$menu' WHERE id='$id'";
		...
		unlink("../sanpham/large/$name");
			...
			//********************************resize hinh ********************************
		$sql4="UPDATE sanpham SET id='$id2', id_loai='$loaisp', tensp='$tensp', mota='$mota',hinh='$newName',soluongnhaphang='$soluongnhaphang', gia='$gia',ghichu='$ghichu',id_menu='$menu' WHERE id='$id'";
...
<?php
	...
	else 
	{
		...
		$gia=$r["gia"];$ghichu=$r["ghichu"];$soluongnhaphang=$r["soluongnhaphang"];$id_menu=$r["id_menu"];
	//	echo "$id_loai";
?>
