<?php
include "connect.php";
$mota="";$gia="";$tensp="";$ghichu="";$soluongnhaphang="";
if(isset($_POST["act"]))
{//(1)
	$loaisp=$_POST["loaisp"];
	...
	$soluongnhaphang = $_POST['soluongnhaphang'];
	$id=md5($kd);
	...
	{//(3)
		$n=$_REQUEST["n"];
		if($n=="menu")
			$sql="insert into sanpham(id,tensp,mota,hinh,gia,ghichu,id_menu,soluongnhaphang) values ('$id','$tensp','$mota','$newName','$gia','$ghichu',$menu,'$soluongnhaphang')";
	}//(3)
	else{
		$sql="insert into sanpham(id,id_loai,tensp,mota,hinh,gia,ghichu,soluongnhaphang) values ('$id',$loaisp,'$tensp','$mota','$newName','$gia','$ghichu','$soluongnhaphang')";}
//	echo "$sql<hr>";
	$kq=mysql_query($sql);
	if(!$kq){
...
//********************************resize hinh ********************************//	
		...
		$loaisp="";$mota="";$gia="";$tensp="";$ghichu="";$soluongnhaphang="";
	}//(4)
...
<table width="735" border="0" cellspacing="0" cellpadding="0" ">
  ...
  <?php
  if(isset($_REQUEST["n"]))  
	  echo "<form method=\"post\" enctype=\"multipart/form-data\" onsubmit=\"return sp_insert_m(menu.value,tensp.value,hinh.value,ghichu.value,soluongnhaphang.value);\" id=\"forminsert\" name=\"forminsert\">";
  else
	  echo "<form method=\"post\" enctype=\"multipart/form-data\" onsubmit=\"return sp_insert(loaisp.value,tensp.value,hinh.value,ghichu.value,soluongnhaphang.value);\" id=\"forminsert\" name=\"forminsert\">";
  ...
  <tr>
	...
	<tr>
    <td style="padding-left:80px" height="30">Số lượng nhập:</td>
    <td><input type="text" name="soluongnhaphang" style="width:240px" value="<?php echo "$soluongnhaphang"; ?>"></td>
  </tr>
