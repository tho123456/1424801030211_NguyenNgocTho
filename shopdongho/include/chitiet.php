...
<?php
	...
	$tensp=$r["tensp"];$tenloaisp=$r["tenloaisp"];$tinhtrang=$r["tinhtrang"];$soluongban=$r["soluongban"];$soluongnhaphang=$r["soluongnhaphang"];
...
thanh toán:</td>
  ...
  <tr>
    <td height="70" style="padding-left:20px; border-bottom:1px dotted #666; border-right:1px dotted #666">Tình trạng kho:</td>
    <td style="padding-left:5px"><p>  
      <?php 
     $hangton= $soluongnhaphang - $soluongban;
		if($hangton==0) echo "Hết hàng - vui lòng liên hệ qua điện thoại ";
		else echo "Còn Hàng";
    	?>
